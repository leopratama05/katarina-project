...
<body>
     ...
     <section class="navbar custom-navbar navbar-fixed-top" role="navigation">
          <div class="container">
               ...
               <div class="navbar-header">
                    ...
                    <!-- lOGO TEXT HERE -->
                    <a href="#home" class="navbar-brand">Katarina</a>
               </div>
               ...
               <div class="collapse navbar-collapse">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                         <li>
                         <a href="{{ route('login')}}" class="btn btn-danger">Login</a></li>
                    </ul>
               </div>
     ...
     <!-- MENU-->
     <section id="menu" data-stellar-background-ratio="0.25">
          <div class="container">
               <div class="row">
     ...
     <!-- TESTIMONIAL -->
     <section id="testimonial" data-stellar-background-ratio=".25">
